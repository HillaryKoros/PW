...
import LocustIcon from "../locust-icon";
...
export default function TrajectoryMap({
  ...
  const getBasemapUrl = () => {
    switch (selectedBasemap) {
      ...
      case "icpac-droughtwatch":
        return "https://eahazardswatch.icpac.net/tileserver-gl/styles/droughtwatch/{z}/{x}/{y}.png";
      case "hybrid":
        return "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}";
      case "osm":
      default:
  ...
  return (
    <div className="h-full w-full overflow-hidden">
      ...
      >
        ...
        {/* Admin Boundaries - ALWAYS RENDER LAST TO STAY ON TOP */}
        <AdminBoundariesLayer
          visible={showAdminBoundaries || showAdmin0 || showAdmin1}

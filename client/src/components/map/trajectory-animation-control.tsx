...
export default function TrajectoryAnimationControl({
  ...
  return (
    <Card className="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-[10000] bg-white/95 backdrop-blur-sm border border-gray-300 shadow-lg pointer-events-auto">
